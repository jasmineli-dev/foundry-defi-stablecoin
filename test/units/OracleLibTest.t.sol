...
contract OracleLibTest is StdCheats, Test {
    ...
    function testGetTimeout() public {
        uint256 expectedTimeout = 3 hours; //10800 seconds
        //                        ↑ This is a TIME UNIT in Solidity, and will compile it to 10800;
    ...
    function testPriceRevertsOnBadAnsweredInRound() public {
        ...
        vm.expectRevert(OracleLib.OracleLib__StalePrice.selector);
        AggregatorV3Interface(address(aggregator)).staleCheckLatestRoundData();
        // staleCheckLatestRoundData() was defined in the OracleLib, not in the AggregatorV3Interface.
        // As "using OracleLib for AggregatorV3Interface;" statement, this line make sense.
    }
}
