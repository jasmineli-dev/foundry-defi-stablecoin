...
contract DecentralizedStablecoinTest is StdCheats, Test {
    ...
    function testMustMintMoreThanZero() public {
        ...
        vm.expectRevert(
            DecentralizedStableCoin
                .DecentralizedStableCoin_InvalidMintAmount
                .selector
        );
    ...
    function testCantMintToZeroAddress() public {
        ...
        vm.expectRevert(
            DecentralizedStableCoin
                .DecentralizedStableCoin_MintToZeroAddress
                .selector
        );
    ...
    function testMustBurnMoreThanZero() public {
        ...
        vm.expectRevert(
            DecentralizedStableCoin
                .DecentralizedStableCoin_InvalidBurnAmount
                .selector
        );
        dsc.burn(0);
        vm.stopPrank();
    ...
    function testCantBurnMoreThanYouHave() public {
        ...
        vm.expectRevert(
            DecentralizedStableCoin
                .DecentralizedStableCoin_InsufficientBalance
                .selector
        );
        dsc.burn(101);
        vm.stopPrank();
